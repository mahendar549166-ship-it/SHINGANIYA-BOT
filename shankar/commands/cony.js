this.config = {
    ...
    description: "Is saal aapke partner banne ki sambhavna",
...
this.run = async function({ api, event, Users }) {
    ...
    var callback = () => api.sendMessage({body:`🌸 Badhai ho ${name}, Bot anuman karta hai ki is saal aapke partner banne ki sambhavna ${tle}% hai ❤🌸`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
