...
module.exports.run = async function ({ api, event, args }) { 
 ...
 thu = moment.tz('Asia/Kolkata').format('dddd');
 ...
 date = moment.tz("Asia/Kolkata").subtract(1, 'days').format("DD-MM-YYYY");
 thu = moment.tz('Asia/Kolkata').subtract(1, 'days').format('dddd');
 if (thu == 'Sunday') thu = 'Chủ Nhật';
 if (thu == 'Monday') thu = 'Thứ Hai';
 if (thu == 'Tuesday') thu = 'Thứ Ba';
 if (thu == 'Wednesday') thu = 'Thứ Tư';
