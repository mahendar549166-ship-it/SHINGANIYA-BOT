...
module.exports.config = {
  ...
  description: "Loto khel khelein",
  usages: "[create/join/start]\n---------o>\ncreate [số tiền] (kam se kam 50 dollar)\njoin (balance create karne wale ke daav ke barabar ya usse zyada hona chahiye)\nstart (khel shuru karein)\n---------o>",
  commandCategory: "Khel",
  cooldowns: 5,
  envConfig: {
    maxPlayers: 10, // Kam se kam 2, zyada se zyada 10
    getDelay: 8 // Number nikalne ka delay (seconds mein)
  }
};
...
module.exports.languages = {
  "en": {
    "missingInput": "[ LOTO ] Daav ki rashi khali nahi ho sakti ya negative nahi honi chahiye",
    "moneyBetNotEnough": "[ LOTO ] Aapka balance kaafi nahi hai, aapko %1 dollar chahiye!",
    "limitBet": "[ LOTO ] Daav ki rashi 50 dollar se kam nahi ho sakti!",
    "noGame": "[ LOTO ] Aapke group mein koi loto ka khel chal nahi raha hai!",
    "alreadyHave": "Is group mein ek loto ka khel pehle se chal raha hai!",
    "openSuccess": "Khel safalta se shuru ho gaya! (%1/%2)\nBhaag lene ke liye, istemal karein:\n%3 join",
    "alreadyJoined": "Aap pehle se hi kamre mein hain",
    "out_of_room": "Jagah khatam ho gayi hai...",
    "alreadyStarted_1": "Khel shuru ho chuka hai, ab bhaag nahi le sakte!",
    "joinSuccess": "Safalta se join kar liya! (%1/%2)",
    "playersNotEnough": "Kaafi khiladi nahi hain, kam se kam: 2, abhi hain: 1",
    "not_author": "Aap kamre ke malik nahi hain",
    "alreadyStarted_2": "Khel chal raha hai!",
    "testInbox": "Khiladiyon ke inbox ki sthiti jaanch raha hai...",
    "checkInbox_noti": "Bot har khiladi ko ticket bhejega, kripya apna inbox/spam/message request check karein",
    "cannotInbox": "%1, bot aapko message nahi bhej sakta, kripya pehle bot ko message karein taaki bot ke liye inbox unlock ho",
    "notJoined": "Aapne abhi tak bhaag nahi liya hai!",
    "getReady": "Shuru karte hain!\nHar %1 second baad, bot ek number nikale ga!",
    "gotNum": "Number %1",
    "BINGO": "Badhai ho %1 ne BINGO kiya (jeet gaya) aur inaam ke roop mein %2 dollar mile hain",
    "notReady": "Bot kuch logon ko message nahi bhej sakta, ya bot khud inbox mein block ho chuka hai, shuru nahi kar sakta.",
    "info": "[ LOTO ]\n- Haan, yeh wahi loto hai xD -\n+ Jab aap create command use karte hain, toh daav ki rashi wahi hogi jo doosre khiladiyon ko join karne ke liye chahiye, jaise agar 100 dollar daav rakha toh doosron ko bhi 100 dollar chahiye honge!\n+ Bot ek nirdharit samay ke baad number ginega, jaise har 5 second mein bot ek number nikale ga aur group mein bhejega, khiladi apne inbox mein bot ke bheje ticket ke saath number match karenge, jab ek horizontal line ke saare number mil jayenge, woh khiladi jeet jayega aur inaam mein sabhi khiladiyon ke daav ka total milega, jabki haarne wale sirf apna daav hi kho denge."
  }
};
