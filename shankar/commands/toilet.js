...
try {
  ...
  const canvas = Canvas.createCanvas(500, 670);
	...
	api.sendMessage({attachment: fs.createReadStream(path_toilet, {'highWaterMark': 128 * 1024}), body: "Toilet mein baitha avatar!"}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
