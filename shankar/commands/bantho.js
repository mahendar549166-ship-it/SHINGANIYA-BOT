module.exports.config = {
  ...
  description: "Phub par comment karne ka khel ( ͡° ͜ʖ ͡°)",
...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  if (!text)
    return api.sendMessage("Phub comment ke liye content daalain", threadID, messageID);
  let getPorn = (
  ...
  return api.sendMessage(
    { body: "Alvida doston!!!", attachment: fs.createReadStream(pathImg) },
    threadID,
