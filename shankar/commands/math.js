module.exports.config = {
	...
	description: "Ganit ke sawal hal karein",
	commandCategory: "Tool",
	usages: "+(-p, -g, -v) + ganit ka prashn\n  -p: Antargrahan ya samakalan karein\n  -g: Graph banayein\n  -v: Vector ke coordinates nikalein\n  Koi option nahi: Asan ganit ke sawal hal karein\n  Udaaharan: !math -g y = x^3 - 9",
	cooldowns: 5,
	dependencies: {
		"axios": "",
		"fs-extra": ""
...
module.exports.run = async function ({ api, event, args }) {
	...
	if (!content) return out("Kripya ganit ka prashn daalein");
