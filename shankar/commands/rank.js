module.exports.config = {
	...
	description: "Bot system par apka current rank aur level ke hisaab se frame prapt karein, canvacord se rank_card ka remake",
...
module.exports.run = async ({ event, api, args, Currencies, Users }) => {
	...
	if (mention.length == 1) {
		...
		if (rank == 0) return api.sendMessage("Yeh vyakti abhi database mein nahi hai, isliye uska rank nahi dekh sakte, kripaya 5 second baad dobara koshish karein.", event.threadID, event.messageID);
